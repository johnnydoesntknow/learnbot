...
module.exports = {
  ...
  weekNumber: 1,  //change this for different weeks example 2, 3, 4
...
Edit backend/data/weeklyContent.js
Change weekNumber
Update lessons and quizzes
Save file
Restart backend (Ctrl+C then yarn dev)
Watch for the sync confirmation messages in terminal
*/
